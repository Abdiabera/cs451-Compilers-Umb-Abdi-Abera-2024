...
class JMethodDeclaration extends JAST implements JMember {
    ...
    public void preAnalyze(Context context, CLEmitter partial) {
        ...
        if (exceptions != null) {
            ...
            ArrayList<Type> resolvedExceptions = new ArrayList<Type>();
            for (TypeName exception : exceptions) {
                Type resolvedException = exception.resolve(context);
                resolvedExceptions.add(resolvedException);
                exceptionNames.add(resolvedException.jvmName());
            }
        }
        // Resolve return type.
